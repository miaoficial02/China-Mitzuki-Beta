...
await conn.reply(m.chat, `> 🌙 🄻𝐮𝐧𝐚 ha eliminado a @${m.sender.split`@`[0]} del grupo por \`Anti-Link\`! No permitimos enlaces de ${isChannelLink ? 'canales' : 'otros grupos'}.`, null, { mentions: [m.sender] })
if (isBotAdmin) {
try {
